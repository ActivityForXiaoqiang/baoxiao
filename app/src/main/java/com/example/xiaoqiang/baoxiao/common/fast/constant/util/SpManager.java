...
//        MyUser user = BmobUser.getCurrentUser(MyUser.class);
    ...
    public Integer getNextPoint(Integer point, Integer proccesType) {
        ...
        if (proccesType == FastConstant.PROCESS_TYPE_THREE) {
            //需要跳过五级
